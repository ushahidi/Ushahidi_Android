...
public class CustomFormEntity extends Model implements IDbEntity {
	...
	public static CustomFormEntity build(CustomForm form){
		CustomFormEntity cf = new CustomFormEntity();
