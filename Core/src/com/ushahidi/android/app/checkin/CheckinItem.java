...
public class CheckinItem {
    ...
    public CheckinItem(Drawable thumbnail, String title, String date, String status,
    ...
    public CheckinItem(Uri uri, String title, String date, String status, String description,
