...
public class MainHttpClientBak {
    ...
    public static HttpResponse GetURL(String URL) throws IOException {
        ...
        try {
            ...
            // works):
            HttpResponse response = BackgroundService.httpclient.execute(httpget);
    ...
    public static HttpResponse PostURL(String URL, List<NameValuePair> data, String Referer)
        ...
        try {
            ...
            // works):
            try {
                HttpResponse response = BackgroundService.httpclient.execute(httpost);
                Preferences.httpRunning = false;
                return response;
