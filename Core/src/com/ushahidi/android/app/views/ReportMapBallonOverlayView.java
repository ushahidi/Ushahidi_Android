...
public class ReportMapBallonOverlayView<Item extends OverlayItem> extends
    ...
    public ReportMapBallonOverlayView(Context context, int balloonBottomOffset, Activity activity) {
    ...
    protected void setupView(Context context, final ViewGroup parent) {
        ...
        android.view.View v = inflater.inflate(R.layout.map_balloon_overlay, parent);
