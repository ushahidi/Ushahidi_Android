 ...
 * @author eyedol
 */
public class ViewReportActivity2 extends BaseMapViewActivity<ViewReportView, ViewReportModel>
    ...
    /*
     * private class MapMarker extends ItemizedOverlay<OverlayItem> { private
     * List<OverlayItem> locations = new ArrayList<OverlayItem>(); private
     * Drawable marker; private OverlayItem myOverlayItem; public
     * MapMarker(Drawable defaultMarker, int LatitudeE6, int LongitudeE6) {
     * super(defaultMarker); this.marker = defaultMarker; // create locations of
     * interest GeoPoint myPlace = new GeoPoint(LatitudeE6, LongitudeE6);
     * myOverlayItem = new OverlayItem(myPlace, " ", " ");
     * locations.add(myOverlayItem); populate(); }
